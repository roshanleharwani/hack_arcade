                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateFormData("entryFee", e.target.value)
                        }
                        className="border-2 border-black"
                        placeholder="0.00"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateFormData("prizePool", e.target.value)
                        }
                        className="border-2 border-black"
                        placeholder="0.00"
                      />
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between border-2 border-black p-4">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateFormData("streamRequired", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between border-2 border-black p-4">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateFormData("allowSpectators", checked)
                        }
                      />
                    </div>
                  </div>
