...
import { Trophy, Search, Users, Clock, ChevronRight, Filter } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-gray-800">Find and join tournaments across different games</p>
            </div>
            <Button onClick={() => router.push('/create-tournament')} className="bg-black text-white hover:bg-black/90 border-2 border-black shadow-[4px_4px_0px_0px_#FF5E5B] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all">
              Create Tournament
            </Button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
              ...
              >
                <Card className="border-2 border-black hover:translate-y-[-4px] transition-transform ">
                  <CardContent className="p-0">
                    <div className={`${game.color} p-4 border-b-2 border-black`}>
                      <Image
                    ...
                    <div className="p-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-bold">{game.activeTournaments}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Total Prize Pool</span>
                          <span className="font-bold">{game.totalPrizePool}</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList className="border-2 border-black p-1 bg-white">
            ...
            <TabsTrigger value="live" className="data-[state=active]:bg-[#00CECB] data-[state=active]:text-white">
              Live Now
            </TabsTrigger>
            <TabsTrigger value="upcoming" className="data-[state=active]:bg-[#00CECB] data-[state=active]:text-white">
              Upcoming
            </TabsTrigger>
            <TabsTrigger value="completed" className="data-[state=active]:bg-[#00CECB] data-[state=active]:text-white">
              Completed
            </TabsTrigger>
          </TabsList>
